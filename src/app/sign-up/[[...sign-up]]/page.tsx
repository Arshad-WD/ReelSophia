    ...
    >
      ...
      <div className="w-full max-w-lg relative z-10 px-6 reveal-up stagger-1">
        <header className="text-center mb-16 space-y-8">
          <div className="flex flex-col items-center gap-6">
            ...
            <div className="space-y-2">
              <span className="text-[10px] font-bold tracking-[0.8em] uppercase text-primary/60 inline-block pl-2">System Registry Active</span>
        ...
        <div className="velvet-card p-10 sm:p-14 shadow-[0_50px_100px_-20px_rgba(0,0,0,0.8)] border-white/[0.05] relative overflow-hidden group">
          ...
          <div className="text-white/20 text-center mb-10 font-bold uppercase tracking-[0.5em] text-[9px]">Begin your journey into structured intelligence</div>
          <RegisterForm />
        </div>

        <footer className="mt-16 text-center opacity-20">
           <p className="font-mono text-[8px] uppercase tracking-[1em] text-white">Sophia OS // Registry Ledger</p>
        </footer>
      </div>
    </div>
  );
